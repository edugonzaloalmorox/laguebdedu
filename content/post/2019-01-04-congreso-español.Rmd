...
congress_long %>% 
  ...
  coord_flip() + 
  theme_ipsum(grid = "") + 
  labs(title = "Interrupciones de las sesiones", subtitle = "Peticiones de silencio",  x= " ",  y = "Número de veces", caption = "Fuente: congreso.es | @EduGonzalo") 
...
Aunque las sesiones más “accidentadas” se produjeron bajo el gobierno del PSOE, ello no implica que el tono de las sesiones fuera muy diferente con respecto a las sesiones del PP.  Midiendo las palabras más frecuentes durante ambos gobiernos vemos que hay bastantes palabras que coinciden. No obstante, también hay palabras particulares para cada gobierno. Destacan __“presupuestos”__ durante el mandato de PP y __“ministra"__ o __“cataluña”__ durante el mandato del PSOE. La últimas estén asociadas probablemente a dos hechos. Por un lado, la composición del ejecutivo de Pedro Sánchez [con más mujeres](https://www.france24.com/es/20180606-espana-pedro-sanchez-ministros-mujeres) que hombres. Por otro, la estrategia [acercar posturas](https://www.europapress.es/illes-balears/noticia-armengol-cree-gobierno-intenta-acercar-posturas-cataluna-ve-irresponsable-actitud-generalitat-20181213144628.html) con el Govern catalán ante la crisis en Cataluña. 
